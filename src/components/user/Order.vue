	...
	<div>
		...
		<div class="mw9 center ph3-ns mt5-ns">
			<div class="cf ph2-ns">
				...
				<div class="fl w-100 w-50-ns ph2 tl">
					<h4 class="f2">{{ name }}</h4>
					<p class="lh-copy">{{ location }}</p>
					<p class="b f5 mv3">Upload dokumenmu disini</p>
					<label for="file">Choose your file : </label>
					<input id="input-file" placeholder="Tambahkan File" class="db mv3" type="file" name="file" />
					<input id="input-message" placeholder="Tambahkan Pesan" class="db mv4" type="text" />

					<p class="f4 b ttu">pembayaran</p>
					...
					<p class="f4 b ttu">total harga</p>
					<p class="f4 b">Rp {{ total }}</p>
					<hr>
